...
//            please do not delete this line - this will be helpful if you experience export issues
            wp_mail(
                'info@pomuabot.com',
        ...
        public function add_vendor_field()
        {
            ...
            woocommerce_wp_text_input(
                array(
                    ...
                    'label' => 'Виробник',
                    'placeholder' => '',
                    'description' => 'Якщо не заповнено, то не бере участі у вивантаженні до маркету',
                    'type' => 'text',
                )
            );
            echo '</div>';
